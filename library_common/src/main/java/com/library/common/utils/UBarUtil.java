...
public class UBarUtil {
    ...
    public static int getStatusBarHeight() {
        Resources resources = App.mInstance.getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (App.mInstance.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, App.mInstance.getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = App.mInstance.getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = App.mInstance.getResources();
