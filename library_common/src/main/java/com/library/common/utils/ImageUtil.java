...
public class ImageUtil {
    ...
    public static Drawable getDrawable(int resId) {
        return App. mInstance .getResources().getDrawable(resId);
    }
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return bitmap == null ? null : new BitmapDrawable(App.mInstance.getResources(), bitmap);
    }
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId) {
        Drawable drawable = ContextCompat.getDrawable(App.mInstance, resId);
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId,
                                   ...
                                   final int maxHeight) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        final Resources resources = App.mInstance.getResources();
        options.inJustDecodeBounds = true;
